...
Saves best model it finds to best_textcnn.pt
"""
...
def main():
    ...
    best_accuracy, best_lr, best_wd, best_cnn_hd, best_dr = 0, 0, 0, 0, 0
    for cnn_hd, dr, lr, wd in tqdm(
        itertools.product(cnn_dense_hidden_dim, dropout_rate, lr, weight_decay),
        total=total_comb
    ):
        ...
        if stats['accuracy'] > best_accuracy:
            ...
            best_lr, best_wd, best_cnn_hd, best_dr = lr, wd, cnn_hd, dr
            torch.save(best_model.state_dict(), 'best_textcnn.pt')
    print("\n\nBest cnn hidden: {}, Best weight_decay: {}, Best lr: {}, Best dropout: {}".format(
        best_cnn_hd, best_wd, best_lr, best_dr))
